...
if ($OCN_GRID == gx3v7) then
   ...
   set IC_file  = $DIN_LOC_ROOT/$relpath/ic/ecosys_cesmi6gat31_jan_IC_gx3v7_20181009.nc
   set IC_fmt   = nc
   set ALK_scale_factor = 1.025
   set DIC_scale_factor = 1.025
   set O2_scale_factor  = 44.66
   set DST_file   = $DIN_LOC_ROOT/$relpath/forcing/dst79gnx_cesmi6gat31_gx3v7_20181010.nc
   set fesed_file = $DIN_LOC_ROOT/$relpath/forcing/fesedflux_CCSM4gx3v7_orgc_etopo2v2_20100307.nc
   if ($OCN_TRANSIENT == unset) then
     set ndep_file  = $DIN_LOC_ROOT/$relpath/forcing/ndep_ocn_1850_cesmi6gat31_gx3v7_c100428.nc
   endif
